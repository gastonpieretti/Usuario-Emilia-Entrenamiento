...
export default function OnboardingPage() {
    ...
    const handleFinalSubmit = async () => {
        ...
        try {
            ...
            if (!userId) {
                // Si no hay ID, intentamos recargar o avisar
            ...
            alert('Error al guardar. Tu sesión puede haber expirado. Por favor, recarga la página e inicia sesión de nuevo.');
        } finally {
            setLoading(false);
        }
    };
        ...
        return (
            <div className="min-h-screen bg-white flex items-center justify-center p-6 font-sans">
                ...
                >
                    ...
                    <h2 className="text-4xl font-light tracking-tight text-gray-900 uppercase">
                        Perfil Creado
                    </h2>
                    <p className="text-gray-500 font-light text-lg">
                        Tu plan personalizado está siendo procesado por Emilia.
                    </p>
                    <button
